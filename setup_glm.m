function [aa_struct] = setup_defaults(aap,RESULTS_DIR,DATA_PATH,ROOT_PATH,TPM_DIR,process_4D,default_garbage_collection)
    ...
    aap.options.garbagecollection = default_garbage_collection;
